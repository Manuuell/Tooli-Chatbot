...
toolsRouter.get('/crm/fichas', async (_req: AuthedRequest, res: Response) => {
  try {
...
toolsRouter.get('/crm/:phone', async (req: AuthedRequest, res: Response) => {
  const phone = normalizePhone(req.params.phone);
  if (!phone) {
    res.status(400).json({ error: 'invalid_phone' });
    return;
...
toolsRouter.post('/crm/:phone/nota', async (req: AuthedRequest, res: Response) => {
  const phone = normalizePhone(req.params.phone);
  if (!phone) {
    res.status(400).json({ error: 'invalid_phone' });
    return;
...
toolsRouter.delete('/crm/:phone/nota/:notaId', async (req: AuthedRequest, res: Response) => {
  const phone = normalizePhone(req.params.phone);
  if (!phone) {
    res.status(400).json({ error: 'invalid_phone' });
    return;
...
toolsRouter.post('/crm/:phone/estado', async (req: AuthedRequest, res: Response) => {
  const phone = normalizePhone(req.params.phone);
  if (!phone) {
    res.status(400).json({ error: 'invalid_phone' });
    return;
...
toolsRouter.post('/crm/:phone/asignar', async (req: AuthedRequest, res: Response) => {
  const phone = normalizePhone(req.params.phone);
  if (!phone) {
    res.status(400).json({ error: 'invalid_phone' });
    return;
...
toolsRouter.post('/crm/:phone/etiquetas', async (req: AuthedRequest, res: Response) => {
  const phone = normalizePhone(req.params.phone);
  if (!phone) {
    res.status(400).json({ error: 'invalid_phone' });
    return;
...
toolsRouter.get('/quick-replies', async (_req: AuthedRequest, res: Response) => {
  try {
...
toolsRouter.post('/quick-replies', async (req: AuthedRequest, res: Response) => {
  try {
...
toolsRouter.delete('/quick-replies/:id', async (req: AuthedRequest, res: Response) => {
  try {
